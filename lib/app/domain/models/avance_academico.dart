class AvanceAcademico {
  ...
  factory AvanceAcademico.fromJson(Map<String, dynamic> json) {
...
class Nota {
  Nota({required this.nota, required this.grupoMateriaId});

  factory Nota.fromJson(Map<String, dynamic> json) {
    return Nota(nota: json['nota'], grupoMateriaId: json['grupoMateriaId']);
  }
  ...
  @override
  String toString() {
    return '{"nota": $nota, "grupoMateriaId": "$grupoMateriaId"}';
  }
}
